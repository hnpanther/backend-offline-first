...
| V2 | `V2__asset_status_request_reading_time.sql` | Added `asset_status_change_requests.reading_recorded_at` |
...
`PENDING`/`RUNNING` blocks all future imports; see [jobs.md](jobs.md#excel-import-jobs) for
the recovery path and its known limitation.
